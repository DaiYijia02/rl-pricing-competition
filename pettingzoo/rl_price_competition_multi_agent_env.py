...
from pettingzoo.rl_price_competition_multi_agent_env_base import MultiPriceCompetitionEnv as _env
...
class raw_env(AECEnv, EzPickle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.agents = ["seller_" + str(r) for r in range(self.env.n_sellers)]
        self.possible_agents = self.agents[:]
        self.agent_name_mapping = dict(zip(self.agents, list(range(self.env.n_sellers))))
